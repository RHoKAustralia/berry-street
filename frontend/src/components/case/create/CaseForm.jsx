            ...
            <div className="row">
              <div className="col-md-6">
                <div className="form-group">
                  ...
                  <input type="date" className="form-control" id="dateOpened" placeholder="Date Opened" {...dateOpened} />
                </div>
              </div>
              <div className="col-md-6">
                <div className="form-group">
                  <label htmlFor="dateClosed">Date Closed</label>
                  <input type="date" className="form-control" id="dateClosed" placeholder="Date Closed" {...dateClosed} />
                </div>
              </div>
            </div>
            <div className="row">

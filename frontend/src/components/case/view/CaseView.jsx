...
import CaseRelationship from './relationshipEdit/CaseRelationship.jsx'
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-6 col-md-9">
            <CaseRelationship personId={person.id} relationshipId={this.state.selectedRelationshipId} />
          </div>
        </div>
      </div>
    )
